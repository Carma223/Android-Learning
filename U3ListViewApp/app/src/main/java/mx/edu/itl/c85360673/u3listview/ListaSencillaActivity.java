...
public class ListaSencillaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adaptador = new ArrayAdapter(this, R.layout.list_fila_senscilla, estados);
        ...
        lstvEstados.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long l) {
                txtvResultado.setText("La capital de " + lstvEstados.getItemAtPosition(position) + " es " +
                                        capitales[position]);
