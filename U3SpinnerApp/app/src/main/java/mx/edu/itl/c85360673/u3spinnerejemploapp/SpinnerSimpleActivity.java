...
public class SpinnerSimpleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adaptador = ArrayAdapter.createFromResource(this, R.array.clubes_liga_jmx, android.R.layout.simple_spinner_item);
        adaptador.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spnClubesLigaMx.setAdapter(adaptador);

        clubes = getResources().getStringArray(R.array.clubes_liga_jmx);
        ...
        spnClubesLigaMx.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(SpinnerSimpleActivity.this, "Club seleccionado: " + s1, Toast.LENGTH_SHORT).show();
            }
